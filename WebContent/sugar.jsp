...
function validation(){
	var a=document.form.sugar.value;
	if(a=="")
		{
		alert("please enter blood sugar level");
		document.form.sugar.focus();
		return false;
		}
}
</script>
...
session.setAttribute("id5",e);
%>


<form name="form"action="electrocardiograph.jsp" method="post" onsubmit="return validation()">
<div id="que1">
5)How much Fast Blood sugar level?(90-300)
</div>
<div id="sug">
